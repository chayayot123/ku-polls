"""Adding test case for check the polls will work correctly."""
import datetime
...
class QuestionModelTests(TestCase):
    """Class of the model question that check the code test."""
...
class QuestionIndexViewTests(TestCase):
    """Class of the index view to check the diffrent situation."""
